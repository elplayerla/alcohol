    ...
    $(document).ready(function () {
        ...
        document.querySelectorAll('a[href^="#"]').forEach(anchor => {
            anchor.addEventListener('click', function (e) {
                ...
                if (targetElement) {
                    // 1. Configuración
                    const headerOffset = 90; // Ajusta esto al alto de tu menú
                    ...
                    // 2. Función de aceleración (Easing) para que se sienta natural
                    ...
                    // 3. La animación cuadro por cuadro
